...
export const fetchTradingEquity = async (req, res) => {
...
export const updateTradingEquity = async (req, res) => {
    const supabase = supabaseFromReq(req);
    const body = req.body;
    const { data, error } = await supabase
        .from("trading_account_equity")
...
export const updateTradingAccountEquityMonth = async (req, res) => {
    const supabase = supabaseFromReq(req);
...
//# sourceMappingURL=equity.controller.js.map